...
export default function About() {
  return (
    <section id="about" className="py-5 lg:py-32 scroll-mt-header">
      <div className="container mx-auto px-6 lg:px-20">
        {/* "About" Label */}
        <p className="text-heading font-semibold text-xl lg:text-2xl mb-8 lg:mb-16">About</p>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-24">
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-5 lg:gap-8">
            ...
            {/* Text */}
            <p className="text-body text-lg lg:text-2xl leading-relaxed">
